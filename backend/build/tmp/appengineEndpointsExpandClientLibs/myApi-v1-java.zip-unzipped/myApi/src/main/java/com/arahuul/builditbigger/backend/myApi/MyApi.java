 ...
 * on 2016-07-23 at 19:45:13 UTC 
 * Modify at your own risk.
 */

package com.arahuul.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://android-app-backend-1376.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.arahuul.builditbigger.backend.myApi.model.MyBean}
   * @return the request
   */
  public SayHi sayHi(com.arahuul.builditbigger.backend.myApi.model.MyBean content) throws java.io.IOException {
    SayHi result = new SayHi(content);
    initialize(result);
    return result;
  }

  public class SayHi extends MyApiRequest<com.arahuul.builditbigger.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SayHi(com.arahuul.builditbigger.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.arahuul.builditbigger.backend.myApi.model.MyBean.class);
    }
